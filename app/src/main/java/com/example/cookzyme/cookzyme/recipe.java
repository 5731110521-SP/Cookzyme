...
public class recipe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // zone list view
        // sample food
        String[] name = {"Egg1","Egg2"};
        String[] cal = {"300 cal","200 cal"};
        Integer[] pic = {R.drawable.egg,R.drawable.egg};
        String[] rank = {"1","2"};
        String[] like = {"255","123"};

        final List<String> name_list = new ArrayList<String>(Arrays.asList(name));
        List<String> cal_list = new ArrayList<String>(Arrays.asList(cal));
        List<Integer> pic_list = new ArrayList<Integer>(Arrays.<Integer>asList(pic));
        List<String> rank_list = new ArrayList<String>(Arrays.asList(rank));
        List<String> like_list = new ArrayList<String>(Arrays.asList(like));
        //listview
